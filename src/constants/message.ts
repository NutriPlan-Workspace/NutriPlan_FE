export const ERROR_MESSAGES = {
  ...
  CALORIES_MIN: 'Daily calories must be at least 1,200',
  SELECT_MEALS_COUNT: 'Only 3 meals are currently available',
  NEW_PASSWORD_MUST_BE_DIFFERENT:
    'New password must be different from current password',
  UPDATE_NUTRITION_FAILED: 'Update nutrition target failure!',
  TITLE_REQUIRED: 'Title is required!',
  CALORIES_MAX: 'Daily calories must not exceed 3,000',
